...
tags:
  ...
  - blog
---
The best way to demo a code post is to display a real life post which [originates on andy-bell.design](https://andy-bell.design/wrote/creating-a-full-bleed-css-utility/).
